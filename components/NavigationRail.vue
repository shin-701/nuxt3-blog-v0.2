...
<template>
  <nav 
    class="hidden md:flex fixed left-0 top-0 h-screen w-20 
           bg-m3-surface-container flex-col items-center py-4 gap-2 z-50"
  >
    <!-- Logo / Home -->
    <NuxtLink 
      to="/"
      class="flex flex-col items-center gap-1 py-3 px-2 rounded-full
             m3-state-layer hover:bg-m3-surface-container-high
    ...
    <div class="flex flex-col gap-2 mb-4">
      ...
      >
        <Icon 
          name="mdi:twitter" 
          class="w-5 h-5 text-m3-on-surface-variant"
        />
      </a>
